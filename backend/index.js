...
app.use(cors({
  ...
  //for token auth
  origin: ["https://creative-collective.irinabalanel.com", "https://api.creative-collective.irinabalanel.com", "http://localhost:5173", "https://creative-collective-frontend.onrender.com"],
  // origin: "*",
  methods: ["GET", "POST"],
  credentials: true
}));
