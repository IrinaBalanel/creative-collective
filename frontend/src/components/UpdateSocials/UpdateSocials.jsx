                    ...
                    {Object.values(socialLinks).every((link) => !link.trim()) ? (
                        ...
                        <div className="socials-container">
                            {socialLinks.instagram && (
                                <a className="social-item" href={socialLinks.instagram} target="_blank">
                            ...
                            {socialLinks.linkedin && (
                                <a className="social-item" href={socialLinks.linkedin} target="_blank">
                            ...
                            {socialLinks.facebook && (
                                <a className="social-item" href={socialLinks.facebook} target="_blank">
                            ...
                            {socialLinks.tiktok && (
                                <a className="social-item" href={socialLinks.tiktok} target="_blank">
