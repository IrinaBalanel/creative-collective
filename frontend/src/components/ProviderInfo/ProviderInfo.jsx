...
export default function ProviderInfo({ firstName, lastName, specialization, phone, email, location, bio, verified, profileImage }){
    return(
        <div className="profile"> 
            <div className="profile-img-container"><img src={profileImage}/></div>
