    ...
    return(
        <div className="profile"> 
            ...
            <div className="profile-info">
                ...
                {verified ? (
                    <div className="badge">
                        {verified && <span className="verified"><svg role="presentation" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-patch-check-fill" viewBox="0 0 16 16">
